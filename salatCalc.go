...
// 	if opt.DateStart.IsZero() {
// 		if defaultOpt.DateStart.IsZero() {
// 			return salatOption.SalatOption{}, err.ErrDateMissing
// 		}

// 		opt.DateStart = defaultOpt.DateStart
// 	}
...
// 	yesterdaySunsetOpt.DateStart = yesterdaySunsetOpt.DateStart.Add(-24 * time.Hour)
...
// func (i *impl) AllTimes(opts ...salatOption.ApplyingSalatOption) (model.AllSalatTime, error) {
// 	salatOpt := salatOption.SalatOption{
// 		DateStart:      i.option.DateStart,
// 		FajrZenith:     i.option.FajrZenith,
// 		IshaZenith:     i.option.IshaZenith,
